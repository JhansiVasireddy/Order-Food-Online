...
import animate from "tailwindcss-animate"; // Add import for tailwindcss-animate
import scrollbarHide from "tailwind-scrollbar-hide"; // Add import for tailwind-scrollbar-hide
...
export default {
    ...
    plugins: [animate, scrollbarHide], // Use imported modules
};